...
print(data)`,
  ...
  return (
    <section className="bg-slate-50 flex-grow py-16 sm:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 bg-blue-100 text-blue-700 px-4 py-2 rounded-full text-sm font-semibold mb-4">
            <BookOpen size={18} />
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 mb-8">
          ...
          <div className="space-y-4 text-slate-600 leading-relaxed">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
              <p className="text-sm font-semibold text-slate-700 mb-3">Flujo de trabajo:</p>
              <div className="flex flex-col sm:flex-row items-center gap-3 text-sm">
                <span className="bg-blue-100 text-blue-700 px-3 py-1.5 rounded-lg font-medium">Panel CMS</span>
                <ArrowRight size={18} className="text-slate-400 shrink-0 hidden sm:block" />
                <span className="bg-amber-100 text-amber-700 px-3 py-1.5 rounded-lg font-medium">Crear Campos</span>
                <ArrowRight size={18} className="text-slate-400 shrink-0 hidden sm:block" />
                <span className="bg-emerald-100 text-emerald-700 px-3 py-1.5 rounded-lg font-medium">Publicar</span>
                <ArrowRight size={18} className="text-slate-400 shrink-0 hidden sm:block" />
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900">Estructura del JSON</h2>
          </div>
          <div className="space-y-4 text-slate-600 leading-relaxed">
            <p>
              El endpoint público devuelve un objeto JSON con la siguiente estructura. Todos los campos que hayas
              definido en el editor aparecerán dentro del array <code className="text-blue-600 bg-blue-50 px-1.5 py-0.5 rounded text-sm font-mono">data</code>.
            </p>
      ...
      "type": "link"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
                ...
                <p className="text-xs text-slate-500">Nombre del proyecto. Identificador del sitio al que pertenece el contenido.</p>
              </div>
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
                <p className="text-sm font-bold text-slate-900 mb-1">total_fields</p>
                <p className="text-xs text-slate-500">Número total de campos definidos en este proyecto.</p>
              </div>
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
                <p className="text-sm font-bold text-slate-900 mb-1">data[]</p>
                <p className="text-xs text-slate-500">Array con todos los campos. Cada uno tiene key, value y type.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900">Endpoint de Contenido</h2>
          </div>
          <div className="space-y-4 text-slate-600 leading-relaxed">
            <p>
              Para obtener el JSON publicado, haz una petición GET al siguiente endpoint.
              Reemplaza los valores entre <code className="text-amber-600 bg-amber-50 px-1.5 py-0.5 rounded text-sm font-mono">&lt;&gt;</code> con los datos de tu proyecto.
            </p>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700 leading-relaxed">
                  ...
                  En local, usa <code className="text-amber-800 bg-amber-100 px-1 rounded text-xs font-mono">http://localhost:8000</code>.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 text-slate-600 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-5">
                <p className="text-sm font-bold text-slate-900 mb-2">Obtener tu API Key</p>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-5">
                <p className="text-sm font-bold text-slate-900 mb-2">Formato</p>
                <div className="text-sm space-y-2">
                  <p className="text-slate-600">Las API Keys tienen el formato:</p>
                  <code className="block bg-slate-900 text-emerald-400 rounded-lg p-3 text-xs font-mono break-all">
                    cms_live_abc123def456...
                  </code>
                  <p className="text-slate-500 text-xs">Se pasan como query param: <code className="text-blue-600 bg-blue-50 px-1 rounded">?api_key=...</code></p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900">Ejemplos de consumo</h2>
          </div>
            ...
            {codeSnippets.map((snippet, index) => (
              <div key={index}>
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">{snippet.lang}</span>
                  <button
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900">Tipos de campo</h2>
          </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200">
                  ...
                  <th className="text-left py-3 px-4 font-bold text-slate-700">Descripción</th>
                  <th className="text-left py-3 px-4 font-bold text-slate-700">Ejemplo</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100">
                {fieldTypes.map((ft) => (
                  <tr key={ft.type} className="hover:bg-slate-50 transition-colors">
                    <td className="py-3 px-4">
                      <code className="bg-slate-100 text-slate-800 px-2 py-0.5 rounded text-xs font-mono font-bold">
                        {ft.type}
                      </code>
                    </td>
                    <td className="py-3 px-4 text-slate-600">{ft.description}</td>
                    <td className="py-3 px-4">
          ...
          <p className="mt-4 text-sm text-slate-500">
            El campo <code className="text-blue-600 bg-blue-50 px-1.5 py-0.5 rounded text-xs font-mono">type</code> en el JSON te permite
            saber cómo renderizar cada valor en tu frontend. Por ejemplo, si el tipo es{' '}
            <code className="text-blue-600 bg-blue-50 px-1.5 py-0.5 rounded text-xs font-mono">image</code> debes usar una{' '}
            etiqueta <code className="text-blue-600 bg-blue-50 px-1.5 py-0.5 rounded text-xs font-mono">&lt;img&gt;</code>,{' '}
            si es <code className="text-blue-600 bg-blue-50 px-1.5 py-0.5 rounded text-xs font-mono">link</code> un{' '}
            <code className="text-blue-600 bg-blue-50 px-1.5 py-0.5 rounded text-xs font-mono">&lt;a&gt;</code>, etc.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900">Guardar vs Publicar</h2>
          </div>
          <div className="space-y-4 text-slate-600 leading-relaxed">
            <p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="border border-slate-200 rounded-xl p-5 bg-slate-50">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="font-bold text-slate-900">Guardar</p>
                </div>
              ...
              <div className="border border-slate-200 rounded-xl p-5 bg-emerald-50 border-emerald-200">
                <div className="flex items-center gap-2 mb-3">
                  <div className="w-3 h-3 rounded-full bg-emerald-500" />
                  <p className="font-bold text-slate-900">Publicar</p>
                </div>
                <p className="text-sm text-slate-600">
                  Genera un snapshot del JSON con los campos actuales y lo guarda en la columna{' '}
                  <code className="text-emerald-700 bg-emerald-100 px-1 rounded text-xs font-mono mx-1">published_json</code>.
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900">Ejemplo práctico</h2>
          </div>
          <div className="space-y-4 text-slate-600 leading-relaxed">
            <p>
              Imagina que has creado un proyecto con tres campos: <code className="text-blue-600 bg-blue-50 px-1.5 py-0.5 rounded text-sm font-mono">hero_title</code>,
              <code className="text-blue-600 bg-blue-50 px-1.5 py-0.5 rounded text-sm font-mono">hero_image</code> y
              <code className="text-blue-600 bg-blue-50 px-1.5 py-0.5 rounded text-sm font-mono">cta_link</code>.
