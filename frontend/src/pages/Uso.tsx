    ...
    <div className="max-w-4xl mx-auto pb-16">
      <div className="mb-10">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100">¿Cómo usar tu contenido?</h1>
        </div>
        ...
        {technologies.map(tech => {
          ...
          return (
            ...
            >
              ...
              >
                <span className="font-semibold text-slate-900 dark:text-slate-100">{tech.label}</span>
                <ChevronDown
                  size={20}
              ...
              {isOpen && (
                <div className="border-t border-slate-200 dark:border-slate-700 animate-in slide-in-from-top-1 duration-200">
                  <div className="relative group">
                    ...
                    <button
                      ...
                      className="absolute top-3 right-3 p-2 rounded-lg bg-slate-800 text-slate-400 dark:text-slate-500 hover:text-white hover:bg-slate-700 transition-colors opacity-0 group-hover:opacity-100 focus:opacity-100"
                      title="Copiar código"
                    >
      ...
      <div className="mt-10 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-xl p-5">
        <h3 className="font-bold text-slate-900 dark:text-slate-100 mb-2">Nota sobre el endpoint</h3>
        <p className="text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          El endpoint público <code className="bg-blue-100 dark:bg-blue-900/30 px-1.5 py-0.5 rounded text-blue-800 dark:text-blue-200 font-mono text-xs">GET /api/v1/public/content</code>{' '}
